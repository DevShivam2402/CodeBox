  ...
  return (
    <>
      ...
      <div className="update-container">
        <div className="update-container-max ">
          <div className="update-left">
            <div className="update-text">
              <h1>UNDER CONSTRUCTION.</h1>
              <p>
                A website that’s in Under Construction mode shows a message
                explaining that the site is currently unavailable. All the other
                pages are hidden to visitors during this time, so the owner can
                edit their website content and design behind the scenes, then
                publish their full site again when it’s ready.
              </p>
            </div>
          </div>
