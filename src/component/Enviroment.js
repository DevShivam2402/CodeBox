  ...
  return (
    <div>
      <div className="enviroment-container">
        <div className="enviroment-txt-container">
          <div>
            <h2>Get Started Quicker</h2>
            <p>
              Get inspiration from CodeBox using frameworks, libraries, and design
              patterns. Then, start your own with{" "}
              <strong>premade templates</strong>.
            </p>
            <Link to="/Update" className="text-button button">
              Explore Topics
            </Link>
          </div>
        </div>

        <Link to="/Update" className="enviroment-topic-container">
          <div className="enviroment-topic-img">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="120 0 600 595.3">
              <g fill="#61DAFB">
        ...
        <Link to="/Update" className="enviroment-topic-container">
          <div className="enviroment-topic-img">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 48 48"
              class="h-20 w-20 sm:w-24 sm:h-24 block mr-4 -ml-4"
            >
              <defs>
        ...
        {/* <a href="/topic/sass" class="enviroment-topic-container">
          <div class="enviroment-topic-img">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="512"
              height="384"
        ...
        {/* <a href="/topic/gsap" class="HomepageAnonTopics_topic-Tof2a">
          <div class="HomepageAnonTopics_topicImg-9dsg+">
            <img
